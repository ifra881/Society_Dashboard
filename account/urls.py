...
urlpatterns = [
    ...
    path('logout/', views.user_logout, name='login_view'),
    ...
    path("automation/", views.automation, name="imageprocessing"),
    path('updatetask/<int:id>/', views.updatetask, name='taskupdate'),
